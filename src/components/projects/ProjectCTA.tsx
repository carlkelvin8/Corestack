...
export function ProjectCTA() {
  return (
    <section className="py-24 bg-surface px-margin-mobile md:px-margin-desktop">
      <div className="max-w-4xl mx-auto text-center glass-card rounded-3xl p-12 relative overflow-hidden bg-surface-container-high border border-white/10">
        ...
        <ScrollReveal className="relative z-10">
          ...
          <Link 
            href="/#contact"
            className="inline-flex items-center justify-center px-8 py-4 bg-primary text-white font-label-lg rounded-full hover:bg-primary-light transition-colors shadow-lg hover:shadow-primary/25"
          >
            Contact Us
          </Link>
        </ScrollReveal>
