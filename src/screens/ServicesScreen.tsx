    ...
    <section id="services" className="py-24 bg-surface-gray px-margin-mobile md:px-margin-desktop">
      <div className="max-w-container-max mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 auto-rows-[280px]">
          {/* Service 1: Large */}
          <div className="glass-card rounded-2xl p-8 flex flex-col justify-between group cursor-pointer lg:col-span-2 relative overflow-hidden">
          ...
          {/* Service 2 */}
          <div className="glass-card rounded-2xl p-8 flex flex-col justify-between group cursor-pointer">
          ...
          <div className="glass-card rounded-2xl p-0 flex flex-col md:flex-row lg:col-span-3 overflow-hidden group">
